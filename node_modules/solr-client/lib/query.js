...
Query.prototype.fq = function(filter){
   var self = this;
   var parameter = 'fq=' + encodeURIComponent(filter);
   this.parameters.push(parameter);
   return self;
}

Query.prototype.plf = function(filed){
   var self = this;
   var parameter = 'plf=' + encodeURIComponent(filed);
   this.parameters.push(parameter);
   return self;
}
